...
public class MobileViewer extends JFrame
{
     ...
     * Note: All Mobiles are displayed with horizontal rods as if
     * they are balanced, whether or not they really are.
     */
    public MobileViewer(Mobile m, String title)
    {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setPreferredSize(new Dimension(Mobile.WIDTH, Mobile.HEIGHT));
